...
func _enter_tree() -> void:
	...
	ProjectSettings.add_property_info({name = SETTINGS_PREFIX + "print_backtrace", type = TYPE_BOOL})
	...
	ProjectSettings.add_property_info({name = SETTINGS_PREFIX + "enable_file_logging", type = TYPE_BOOL})
	...
	ProjectSettings.add_property_info({name = SETTINGS_PREFIX + "enable_file_logging.pc", type = TYPE_BOOL})
	...
	ProjectSettings.add_property_info({name = SETTINGS_PREFIX + "colors/verbose_text_color", type = TYPE_COLOR})
	...
	ProjectSettings.add_property_info({name = SETTINGS_PREFIX + "colors/debug_tag_color", type = TYPE_COLOR})
	...
	ProjectSettings.add_property_info({name = SETTINGS_PREFIX + "colors/debug_text_color", type = TYPE_COLOR})
	...
	ProjectSettings.add_property_info({name = SETTINGS_PREFIX + "colors/info_tag_color", type = TYPE_COLOR})
	...
	ProjectSettings.add_property_info({name = SETTINGS_PREFIX + "colors/info_text_color", type = TYPE_COLOR})
	...
	ProjectSettings.add_property_info({name = SETTINGS_PREFIX + "colors/warning_tag_color", type = TYPE_COLOR})
	...
	ProjectSettings.add_property_info({name = SETTINGS_PREFIX + "colors/warning_text_color", type = TYPE_COLOR})
	...
	ProjectSettings.add_property_info({name = SETTINGS_PREFIX + "colors/error_tag_color", type = TYPE_COLOR})
	...
	ProjectSettings.add_property_info({name = SETTINGS_PREFIX + "colors/error_text_color", type = TYPE_COLOR})
	...
	ProjectSettings.add_property_info({name = SETTINGS_PREFIX + "colors/critical_tag_color", type = TYPE_COLOR})
	...
	ProjectSettings.add_property_info({name = SETTINGS_PREFIX + "colors/critical_text_color", type = TYPE_COLOR})
